...
def choose_category(categories):
    ...
    quiz = int(input("Enter quiz category (like 1, 2, 3): "))
    quiz_type = categories[quiz]
    print(f'You chose quiz category {quiz_type}')

types = {1:"Math", 2:"Physics", 3:"Chemistry", 4:"English", 5:"Urdu", 6:"Computer Science", 7:"Psychology"}
choose_category(types)
    #------------------------
